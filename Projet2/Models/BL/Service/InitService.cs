...
namespace Projet2.Models.BL.Service
{
    public class InitService : IInitService
    {
        ...
        public void InitializeDB_AEvents()
        {
            ...
            _bddContext.AssociationEvent.Add(new AssociationEvent { Id = 10, IsHighlighted = false, EventTitle = "Winter Legacy", Description = "Au programme : une course polyvalente ouverte à tous pour se mesurer à cinq disciplines: bosses, géant, super géant, ski cross et water slide. De nombreuses animations sont prévues : DJ, tombola, ski test…etc.", Image = "/FileSystem/Pictures/winter.png", Date = new DateTime(2022, 04, 09), EventType = "Concert", Speakers = "", Artists = "Alexis Pinturault", TicketsTotalNumber = 300, RemainingTickets = 300, AddressId = 6, AssociationId = 1, TicketPrice = 60.00 });
