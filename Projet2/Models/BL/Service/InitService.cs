...
namespace Projet2.Models.BL.Service
{
    public class InitService : IInitService
    {
        ...
        public void InitializeDB_Associations()
        {
            ...
            // 21 -> 30
            _bddContext.Association.Add(new Association { Id = 21, AddressId = 40, Name = "Les enfants du soleil", IsPublished = true, Description = "", Image = "/FileSystem/Pictures/soleil.jpg", AssociationRepresentativeId = 1, Mail = "soleil@gmail.com" });
            ...
            _bddContext.Association.Add(new Association { Id = 23, AddressId = 42, Name = "SOCIETE FRANCAISE DE SANTE PUBLIQUE", IsPublished = true, Description = "Elle a pour objet toutes les questions se rapportant à la santé publique.", Image = "/FileSystem/Pictures/santepub.jpg", AssociationRepresentativeId = 1, Mail = "santepub@gmail.com" });
            _bddContext.Association.Add(new Association { Id = 24, AddressId = 43, Name = "SOCIETE D'HISTOIRE LITTERAIRE DE LA FRANCE", IsPublished = true, Description = "Fournir aux personnes qui s'intéressent à l'histoire de la littérature française des moyens de se réunir d'échanger leurs idées, de profiter en commun des recherches individuelles, d'unir leurs efforts et de grouper leurs travaux.", Image = "/FileSystem/Pictures/histoire.jpg", AssociationRepresentativeId = 1, Mail = "histoire@gmail.com" });
            _bddContext.Association.Add(new Association { Id = 25, AddressId = 44, Name = "Terre d'amitié", IsPublished = true, Description = "Lutter contre la faim et la malnutrition; informer le public sur les problèmes concernant le tiers monde; coopérer sanitairement en faveur du tiers monde.", Image = "/FileSystem/Pictures/amitié.jpg", AssociationRepresentativeId = 1, Mail = "amitié@gmail.com" });
            ...
            _bddContext.Association.Add(new Association { Id = 27, AddressId = 46, Name = "SOCIETE NATIONALE DE SAUVETAGE EN MER (SNSM)", IsPublished = true, Description = "​Les Sauveteurs en Mer interviennent sur demande des centres régionaux opérationnels de surveillance et de sauvetage (CROSS), effectuent les opérations de recherche en mer, assistent les navires en difficulté, évaluent l'état des personnes à secourir, leur donnent les premiers soins et ramènent les blessés et les naufragés à terre où d’autres organismes de secours les prennent en charge.", Image = "/FileSystem/Pictures/snsm.jpg", AssociationRepresentativeId = 1, Mail = "snsm@gmail.com" });
            _bddContext.Association.Add(new Association { Id = 28, AddressId = 47, Name = "SOCIETE GEOLOGIQUE DE FRANCE", IsPublished = true, Description = "Concourir à l'avancement de la géologie en général et particulièrement de faire connaître le sol de la France tant en lui même que dans ses rapports avec les arts industriels et l'agriculture.", Image = "/FileSystem/Pictures/geologue.jpg", AssociationRepresentativeId = 1, Mail = "geologue@gmail.com" });
            _bddContext.Association.Add(new Association { Id = 29, AddressId = 48, Name = "SOCIETE FRANCAISE D'ANESTHESIE ET DE REANIMATION (SFAR)", IsPublished = true, Description = "L'étude, l'avancement et l'enseignement de l'Anesthésiologie, telle qu'elle est définie par l'ordre National des médecins d'anesthésie et réanimation.", Image = "/FileSystem/Pictures/anest.jpg", AssociationRepresentativeId = 1, Mail = "anest@gmail.com" });
            _bddContext.Association.Add(new Association { Id = 30, AddressId = 49, Name = "SOCIETE D'HORTICULTURE DE LA GIRONDE (SHG)", IsPublished = true, Description = "Perfectionnement et les progrès de toutes les branches de l'horticulture des arts et industries qui s'y rattachent; récompenser par des primes diverses tous les mérites horticoles.", Image = "/FileSystem/Pictures/horti.jpg", AssociationRepresentativeId = 1, Mail = "horti@gmail.com" });
